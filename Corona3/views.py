...
def corona3_Document(request,pk):
    ...
    dic = {
            ...
            '#TypeCheck#':corona3.get_TypeCheck_display(),
            '#TypeCheck_Other#':corona3.TypeCheck_Other,
            ...
            '#TypeLive#': corona3.get_TypeLive_display(),
            '#TypeLive_Other#': corona3.TypeLive_Other,
            ...
            '#HospitalProvince#': corona3.HospitalProvince,
            '#ShowSymptom#': corona3.ShowSymptom,
            '#ShowSymptom_O2#': corona3.ShowSymptom_O2,
            '#TypeViolence#': corona3.TypeViolence,
