...
def corona3_Document(request,pk):
    ...
    dic = {
            ...
            '#Age#':str (corona3.Age),            
            '#Nationality#':corona3.get_Nationality_display(),  
            '#CareerPatient#':corona3.CareerPatient,            
            '#Mobile#':str (corona3.Mobile),            
            ...
            '#CaseFemale#':corona3.get_CaseFemale_display(),            
            '#DateCheckRTPCR#':str (corona3.DateCheckRTPCR),            
            '#TypeExampleRTPCR#':corona3.TypeExampleRTPCR,            
            '#PlaceCheckRTPCR#':corona3.PlaceCheckRTPCR,            
            '#ResultsCheckRTPCR#':corona3.get_ResultsCheckRTPCR_display(),            
            ...
            '#ResultsCheckAntigen#':corona3.get_ResultsCheckAntigen_display(),            
