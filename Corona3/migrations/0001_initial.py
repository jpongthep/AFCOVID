    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('PersonID', models.CharField(blank=True, max_length=13, null=True, unique=True, verbose_name='เลขบัตรประชาชน/พาสปอร์ต')),
                ...
                ('Unit', models.CharField(blank=True, default='-', max_length=100, null=True, verbose_name='หน่วยงาน')),
                ...
                ('UserReport', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='Corona3_User', to=settings.AUTH_USER_MODEL, verbose_name='ผู้บันทึกข้อมูล')),
            ],
            options={
